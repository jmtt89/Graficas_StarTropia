...
//Componentes Material Aros
GLfloat mShininess[] = {0.4 * 128}; //Brillosidad
GLfloat DiffuseMaterial[] = {0.9,0.7,0.1,0.0}; //Color del material
//GLfloat DiffuseMaterial[] = {0.4,0.4,0.4,0.0}; //Color del material al ser tocado
GLfloat SpecularMaterial[] = {1.5, 1.5, 1.5, 0.0}; //Refleja Luz
...
void drawmodel(char* C)
{
    ...
    glmDraw(modelo, GLM_MATERIAL | GLM_SMOOTH);
}
